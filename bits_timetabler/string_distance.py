osaCModuleLoaded = None
try:
    import osaCModule
    osaCModuleLoaded = True
except ModuleNotFoundError:
    osaCModuleLoaded = False
...
def osa_distance(string1, string2, ignore_case=False, return_matrix=False):
    ...
    if osaCModuleLoaded and not return_matrix:
        return osaCModule.calcOSADist(string1, string2)
